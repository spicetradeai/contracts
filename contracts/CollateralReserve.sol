...
// File contracts/CollateralReserve.sol
...
contract CollateralReserve is Ownable, ICollateralReserve, Initializable {
    ...
    modifier onlyController() {
        require(controller == msg.sender, "Only controller can trigger this function");
        _;
    }
    ...
    function reserveBalance(address _token) public view returns (uint256) {
